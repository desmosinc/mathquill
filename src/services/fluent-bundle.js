...
// Ensure they are available globally
if (typeof window !== 'undefined') {
  window.FluentBundle = FluentBundle;
  window.FluentResource = FluentResource;
  window.parseResource = parseResource;
} else if (typeof global !== 'undefined') {
  global.FluentBundle = FluentBundle;
  global.FluentResource = FluentResource;
  global.parseResource = parseResource;
}
