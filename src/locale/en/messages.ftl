...
auto-operator-sine = sine
auto-operator-cosine = cosine
auto-operator-tangent = tangent
auto-operator-secant = secant
auto-operator-cosecant = cosecant
auto-operator-cotangent = cotangent
auto-operator-hyperbolic-sine = hyperbolic sine
auto-operator-hyperbolic-cosine = hyperbolic cosine
auto-operator-hyperbolic-tangent = hyperbolic tangent
auto-operator-logarithm = logarithm
auto-operator-natural-logarithm = natural logarithm
auto-operator-common-logarithm = common logarithm
auto-operator-exponential = exponential
auto-operator-limit = limit
auto-operator-supremum = supremum
auto-operator-infimum = infimum
auto-operator-maximum = maximum
auto-operator-minimum = minimum
auto-operator-greatest-common-divisor = greatest common divisor
