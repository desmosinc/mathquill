...
import type { CharCmdsAny, InnerFields, JoinMethod, LatexCmdsAny } from "src/shared_types";
...
import type { CursorOptions, LatexCmdsSingleCharBuilder, MathspeakOptions, NodeRef } from "../shared_types";
