(function (exports) {
    ...
    ***************************************************************************** */
    ...
    var DOMFragment = /** @class */ (function () {
         ...
         */
        DOMFragment.prototype.toJQ = function () {
    ...
    function jQToDOMFragment(jQ) {
        ...
        if (jQ.length === 1)
            return domFrag(jQ[0]);
        for (var i = 0; i < jQ.length - 1; i++) {
            var el = jQ[i];
            var nextEl = jQ[i + 1];
            pray('jQToDOMFragment expects jQ to be a collection of sibling Elements', domFrag(el).next().oneElement() === nextEl);
        }
    ...
    var Aria = /** @class */ (function () {
        ...
        Aria.prototype.attach = function () {
            var container = this.controller.container && this.controller.container.get();
    ...
    var Controller_mouse = /** @class */ (function (_super) {
        ...
        Controller_mouse.prototype.delegateMouseEvents = function () {
            ...
            this.container.bind('mousedown.mathquill', function (e) {
                ...
                var root = (NodeBase.getNodeOfElement(rootjQ[0]) ||
                    NodeBase.getNodeOfElement(ultimateRootElement));
        ...
        Controller_mouse.prototype.seek = function ($target, clientX, _clientY) {
        ...
        Controller_scrollHoriz.prototype.scrollHoriz = function () {
            ...
            if (cursor.domFrag().isEmpty() && !seln) {
                this.root
                    .getJQ()
                    .stop()
                    .animate({ scrollLeft: 0 }, 100, function () {
            ...
            this.root
                .getJQ()
                .stop()
                .animate({ scrollLeft: '+=' + scrollBy }, 100, function () {
                _this.setOverflowClasses();
            });
        };
    ...
    var Controller = /** @class */ (function (_super) {
        ...
        Controller.prototype.createTextarea = function () {
            var textareaSpan = (this.textareaSpan = $(h('span', { class: 'mq-textarea' }))), textarea = this.options.substituteTextarea();
        ...
        Controller.prototype.staticMathTextareaEvents = function () {
            ...
            jQToDOMFragment(this.container).prepend(jQToDOMFragment(this.mathspeakSpan));
            ctrlr.blurred = true;
    ...
    LatexCmds.textcolor = /** @class */ (function (_super) {
        ...
        class_1.prototype.latex = function () {
            var blocks0 = this.blocks[0];
            return '\\textcolor{' + this.color + '}{' + blocks0.latex() + '}';
        };
        class_1.prototype.parser = function () {
            var _this = this;
        ...
        class_1.prototype.isStyleBlock = function () {
            return true;
        };
        return class_1;
    }(MathCommand));
    ...
    (LatexCmds['class'] = /** @class */ (function (_super) {
        ...
        class_2.prototype.latex = function () {
            var blocks0 = this.blocks[0];
            return '\\class{' + this.cls + '}{' + blocks0.latex() + '}';
        };
        class_2.prototype.isStyleBlock = function () {
            return true;
        };
        return class_2;
    }(MathCommand)));
    ...
    function getCtrlSeqsFromBlock(block) {
        ...
        if (!children || !children.getEnd(L))
            return '';
        var chars = '';
        for (var sibling = children.getEnd(L); sibling && sibling[R] !== undefined; sibling = sibling[R]) {
    ...
    var SupSub = /** @class */ (function (_super) {
        ...
        SupSub.prototype.addBlock = function (block) {
            if (this.supsub === 'sub') {
                ...
                block.setDOMFrag(domFrag(h('span', { class: 'mq-sup' }))
                ...
                block.setDOMFrag(domFrag(h('span', { class: 'mq-sub' }))
                    .append(block.domFrag().children())
    ...
    LatexCmds['∫'] =
        LatexCmds['int'] =
            LatexCmds.integral = /** @class */ (function (_super) {
                ...
                class_3.prototype.createLeftOf = function (cursor) {
    ...
    var LiveFraction = (LatexCmds.over =
        CharCmds['/'] = /** @class */ (function (_super) {
            ...
            class_4.prototype.createLeftOf = function (cursor) {
                if (!this.replacedFragment) {
    ...
    var DelimsNode = /** @class */ (function (_super) {
        ...
        DelimsNode.prototype.setDOMFrag = function (frag) {
            var _a;
            _super.prototype.setDOMFrag.call(this, frag);
    ...
    LatexCmds.choose = /** @class */ (function (_super) {
        ...
        class_6.prototype.createLeftOf = function (cursor) {
    ...
    var MathFieldNode = /** @class */ (function (_super) {
        ...
        MathFieldNode.prototype.finalizeTree = function (options) {
            var ctrlr = new Controller(this.getEnd(L), this.getJQ(), options);
    ...
    var EmbedNode = /** @class */ (function (_super) {
        ...
        EmbedNode.prototype.setOptions = function (options) {
            ...
            this.domView = new DOMView(0, function () { return parseHTML(options.htmlString || ''); });
    ...
    LatexCmds.operatorname = /** @class */ (function (_super) {
        ...
        class_1.prototype.createLeftOf = function () { };
        class_1.prototype.numBlocks = function () {
            return 1;
        };
        class_1.prototype.parser = function () {
    ...
    LatexCmds.f = /** @class */ (function (_super) {
        ...
        class_2.prototype.italicize = function (bool) {
    ...
    LatexCmds.phi = bindVariable('\\phi ', '&#981;'); //W3C or Unicode?
    LatexCmds.phiv = LatexCmds.varphi = bindVariable('\\varphi ', '&phi;'); //Elsevier and 9573-13 //AMS and LaTeX
    LatexCmds.epsilon = bindVariable('\\epsilon ', '&#1013;'); //W3C or Unicode?
    LatexCmds.epsiv = LatexCmds.varepsilon = bindVariable(
    //Elsevier and 9573-13 //AMS and LaTeX
    '\\varepsilon ', '&epsilon;');
    LatexCmds.piv = LatexCmds.varpi = bindVariable('\\varpi ', '&piv;'); //W3C/Unicode and Elsevier and 9573-13 //AMS and LaTeX
    LatexCmds.sigmaf = //W3C/Unicode
        LatexCmds.sigmav = //Elsevier
            LatexCmds.varsigma = //LaTeX
                bindVariable('\\varsigma ', '&sigmaf;');
    LatexCmds.thetav = //Elsevier and 9573-13
        LatexCmds.vartheta = //AMS and LaTeX
            LatexCmds.thetasym = //W3C/Unicode
                bindVariable('\\vartheta ', '&thetasym;');
    ...
    LatexCmds.gammad = //Elsevier
        LatexCmds.Gammad = //9573-13 -- WTF, right? I dunno if this was a typo in the reference (see above)
            LatexCmds.digamma = //LaTeX
                bindVariable('\\digamma ', '&#989;');
    LatexCmds.kappav = LatexCmds.varkappa = bindVariable(
    //Elsevier //AMS and LaTeX
    '\\varkappa ', '&#1008;');
    LatexCmds.rhov = LatexCmds.varrho = bindVariable('\\varrho ', '&#1009;'); //Elsevier and 9573-13 //AMS and LaTeX
    ...
    var PlusMinus = /** @class */ (function (_super) {
        __extends(class_4, _super);
        function class_4(ch, html, mathspeak) {
            return _super.call(this, ch, html, undefined, mathspeak, true) || this;
        }
        class_4.prototype.contactWeld = function (cursor, dir) {
            this.sharedSiblingMethod(cursor.options, dir);
        };
        class_4.prototype.siblingCreated = function (opts, dir) {
            this.sharedSiblingMethod(opts, dir);
        };
        class_4.prototype.siblingDeleted = function (opts, dir) {
            this.sharedSiblingMethod(opts, dir);
        };
        class_4.prototype.sharedSiblingMethod = function (_opts, dir) {
            if (dir === R)
    ...
    LatexCmds['+'] = /** @class */ (function (_super) {
        ...
        class_5.prototype.mathspeak = function () {
    ...
    var TextBlock = /** @class */ (function (_super) {
        ...
        TextBlock.prototype.setDOMFrag = function (frag) {
            _super.prototype.setDOMFrag.call(this, frag);
            var endsL = this.getEnd(L);
            if (endsL) {
                var children = this.domFrag().children();
    ...
    function makeTextBlock(latex, ariaLabel, tagName, attrs) {
        return /** @class */ (function (_super) {
            ...
            class_1.prototype.html = function () {
    ...
    API.TextField = function (APIClasses) {
        ...
        return _a = /** @class */ (function (_super) {
                ...
                class_2.prototype.__mathquillify = function () {
                    _super.prototype.mathquillify.call(this, 'mq-editable-field mq-text-mode');
                    return this;
                };
                class_2.prototype.latex = function (latex) {
        ...
        Controller_latex.prototype.renderLatexMathEfficiently = function (latex) {
            ...
            if (!oldMinusSign && newMinusSign) {
                ...
                if (root.getEnd(L) === oldCharNodes[0]) {
                    root.setEnds((_b = {}, _b[L] = newMinusNode, _b[R] = root.getEnd(R), _b));
                }
            ...
            if (oldDigits.length > newDigits.length) {
                ...
                root.setEnds((_c = {}, _c[L] = root.getEnd(L), _c[R] = charNode, _c));
                charNode[R] = 0;
            ...
            if (newDigits.length > oldDigits.length) {
                ...
                for (i = commonLength; i < newDigits.length; i++) {
                    ...
                    newNodeL[R] = newNode;
                    root.setEnds((_d = {}, _d[L] = root.getEnd(L), _d[R] = newNode, _d));
                }
    ...
    var MathCommand = /** @class */ (function (_super) {
        ...
        MathCommand.prototype.html = function () {
            ...
            var node = dom instanceof DocumentFragment ? dom.childNodes[0] : dom;
            while (node) {
    ...
    API.InnerMathField = function (APIClasses) {
        ...
        return /** @class */ (function (_super) {
            ...
            class_1.prototype.makeStatic = function () {
                ...
                jQToDOMFragment(this.__controller.container).removeClass('mq-editable-field');
            };
            class_1.prototype.makeEditable = function () {
                this.__controller.editable = true;
                this.__controller.editablesTextareaEvents();
                this.__controller.cursor.insAtRightEnd(this.__controller.root);
                jQToDOMFragment(this.__controller.container).addClass('mq-editable-field');
            };
            return class_1;
    ...
    var Cursor = /** @class */ (function (_super) {
        ...
        Cursor.prototype.getJQ = function () {
    ...
    var MQSelection = /** @class */ (function (_super) {
        ...
        function MQSelection(withDir, oppDir, dir) {
            ...
            _this.setDOMFrag(_this.domFrag()
        ...
        MQSelection.prototype.adopt = function (parent, leftward, rightward) {
            var childFrag = this.domFrag().children();
    ...
    var Controller_focusBlur = /** @class */ (function (_super) {
        ...
        Controller_focusBlur.prototype.focusBlurEvents = function () {
            ...
            function windowBlur() {
                ...
                if (cursor.selection)
                    cursor.selection.domFrag().addClass('mq-blur');
                blur();
                ctrlr.updateMathspeak();
            }
            function blur() {
    ...
    var NodeBase = /** @class */ (function () {
        ...
        NodeBase.prototype.getJQ = function () {
            return this.domFrag().toJQ();
        };
        NodeBase.prototype.setDOMFrag = function (frag) {
            this._domFrag = frag;
            return this;
        };
        ...
        NodeBase.prototype.joinFrag = function (sibling) {
    ...
    var Fragment = /** @class */ (function () {
        ...
        Fragment.prototype.getJQ = function () {
            return this.domFrag().toJQ();
        };
        Fragment.prototype.setDOMFrag = function (frag) {
            this._domFrag = frag;
            return this;
        };
    ...
    function getInterface(v) {
        ...
        var BaseOptions = v < 2 ? Options : /** @class */ (function (_super) {
        ...
        var AbstractMathQuill = /** @class */ (function (_super) {
            ...
            AbstractMathQuill.prototype.mathquillify = function (classNames) {
                ...
                var contents = jQToDOMFragment(el)
                    ...
                    .children()
                    .detach();
                root.setDOMFrag(domFrag(h('span', { class: 'mq-root-block', 'aria-hidden': 'true' })).appendTo(jQToDOMFragment(el).oneElement()));
                NodeBase.linkElementByBlockNode(root.domFrag().oneElement(), root);
                this.latex(contents.text());
                this.revert = function () {
                    var frag = jQToDOMFragment(el.unbind('.mathquill'))
            ...
            (function (kind, defAPIClass) {
                ...
                MQ[kind] = function (el, opts) {
                    ...
                    if (mq instanceof APIClass || !el || !el.nodeType)
                        return mq;
                    var ctrlr = new Controller(new APIClass.RootBlock(), $(el), new BaseOptions(v));
    ...
    exports.RootBlockMixin = RootBlockMixin;
    exports.optionProcessors = optionProcessors;
